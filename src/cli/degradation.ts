...
import { IdentityS, PolicyS, BeliefS } from "../schema/core.js";
import { makeDemoManifest, makeDemoRoster } from "./demo.js";
import { computeWeightDiversity1000 } from "../analysis/diversity.js";

// Re-exported for backward compatibility: tests/degradation.test.ts imports this
// symbol from here. The implementation now lives in src/analysis/diversity.ts so
// it can be shared with src/cli/formal.ts without duplication/drift.
export { computeWeightDiversity1000 } from "../analysis/diversity.js";
